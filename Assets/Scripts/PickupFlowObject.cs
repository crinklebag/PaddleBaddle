...
[System.Serializable]
class PickupCurrentObject {
	public float magnitude = 10000;
}

public class PickupFlowObject : MonoBehaviour {
	[SerializeField]
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if (other.GetComponentsInChildren<Rigidbody>().Length > 0 && (other.gameObject.CompareTag("Gold") || other.gameObject.CompareTag("Silver") || other.gameObject.CompareTag("Wood") || other.gameObject.CompareTag("PowerUp")))
